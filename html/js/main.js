...
$("#Vidéo").on('shown.bs.modal', function(){
    $("#video").attr('src', 'https://youtube.com/embed/7IpLYzM72ms');
})
// stop playing the youtube video when I close the modal
$('#Vidéo').on('hide.bs.modal', function (e) {
...
function markofun(the_node_as_json, show_the_modal = true) {
	...
	/*var présgé = $('#dropdownMenu1') =="Présentation Générale";
    var botaorig = $('#dropdownMenu1') =="Botanique Origine Extraction";
    var regle = $('#dropdownMenu1') =="Réglementation";
    var otras = $('#dropdownMenu1') =="Autres Remarques";
    var founisseur = $('#dropdownMenu1') =="Fournisseurs";
    var displaytab1 = (false);
    var displaytab2 = (false);
    var displaytab3 = (false);
    var displaytab4 = (false);
    var displaytab6 = (false);
    ...
    if (is_an_naturelle) {
        $('#naturelleModal .modal-header').css('background-color', the_background_color, 'opacity', 0.5);   
