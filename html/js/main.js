...
function markofun(the_node_as_json_EN_and_FR, show_the_modal = true) {
  ...
  $('#modalbody-comment2').append(the_use);
    ...
    if (is_an_naturelle) {
        ...
        $('#modalbody-pictA').append("<img class='imgmp' src=\"../img/matieres_premieres/" + the_img_title + ".PNG\" alt=\"" + the_webpage_title + "\" title=\"" + the_webpage_title + "\" />"); 
    ...
    if (is_an_synthetique) {
        ...
        $('#modalbody-pict1').append("<img class='imgmp' src=\"../img/matieres_premieres/" + the_img_title + ".jpg\" alt=\"" + the_webpage_title + "\" title=\"" + the_webpage_title + "\" />");
