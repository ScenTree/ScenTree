...
$.extend( proto, {
  ...
  _renderItem: function( ul, item) {
      var newText = "<span class='nom_de_l_ingredient m-0 p-0'>" + String(item.label.sci_name).replace(
    ...
    newText = newText + "<br /><span class='synonymes m-0 p-0' style='background-color: blue; white-space: nowrap; width: 100%; overflow: hidden; text-overflow: ellipsis;' >(" + String(item.label["from_csv AutresNoms"]).replace(
                    new RegExp(get_all_accents_in_a_regexp(this.term), "gi"), 
                    "<span class='ui-state-highlight'>$&</span>") + ")</span>";
      };
