...
def compute_the_webpage_address(the_scentree_object, the_langage_in_two_chars):
    """
    ...
    return commons.compute_the_webpage_address(the_EN_name, the_FR_name, the_langage_in_two_chars)
...
with open(sys.argv[1], encoding='utf-8') as the_json_file:
    ...
    for an_ingredient in the_ingredients:
        ...
        def my_regexp_fonction_for_one_language(matchobj, the_ingredients_by_name_for_a_language, the_langage_in_two_chars):
            """
            ...
            the_link_in_html = "<a class='interpop' href='%s'>%s</a>" % (compute_the_webpage_address(the_ingredients_by_name_for_a_language[the_name_in_a_language_of_an_ingredient.lower()], the_langage_in_two_chars), the_name_in_a_language_of_an_ingredient)
        ...
        def my_regexp_fonction_for_EN_language(matchobj):
            return my_regexp_fonction_for_one_language(matchobj, the_ingredients_by_name_EN, 'en')
        def my_regexp_fonction_for_FR_language(matchobj):
            return my_regexp_fonction_for_one_language(matchobj, the_ingredients_by_name_FR, 'fr')
