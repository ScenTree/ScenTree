...
# dev environment : github is inside : /home/maxime/dev_BDD/ScenTree 
...
su - scentree -c "\
	...
	~/src/solr-8.1.1/bin/post -c dev_taxoEN /home/maxime/dev_BDD/TreeFeaturesNEW_EN.json;\
	~/src/solr-8.1.1/bin/post -c dev_taxoFR /home/maxime/dev_BDD/TreeFeaturesNEW_FR.json;\
	~/src/solr-8.1.1/bin/post -c dev_taxoENandFR /home/maxime/dev_BDD/TreeFeaturesNEW_EN_and_FR.json\
	"
