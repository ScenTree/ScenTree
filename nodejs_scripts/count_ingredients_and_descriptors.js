...
// args
const the_third_arg = process.argv[3 -1]; // the path of the file usually called scentree.html
...
if (! fs.existsSync(the_third_arg)) {
    console.log("The file '" + the_third_arg + "' does not exist -> STOP! Please provide a 'scentree.html' file in argument (1st place)" );
    return;
} else {
